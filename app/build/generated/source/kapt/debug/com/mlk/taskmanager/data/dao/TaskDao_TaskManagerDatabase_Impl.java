...
public final class TaskDao_TaskManagerDatabase_Impl implements TaskDao {
  ...
  public TaskDao_TaskManagerDatabase_Impl(@NonNull final RoomDatabase __db) {
    this.__db = __db;
  ...
  @Override
  public Flow<List<Task>> getTasksByProject(final long projectId) {
    final String _sql = "SELECT * FROM tasks WHERE projectId = ? ORDER BY dueDateTime ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
