...
public final class UserRepositoryImpl_Factory implements Factory<UserRepositoryImpl> {
  ...
  public static UserRepositoryImpl_Factory create(Provider<UserDao> userDaoProvider,
      Provider<Context> contextProvider) {
    return new UserRepositoryImpl_Factory(userDaoProvider, contextProvider);
  }

  public static UserRepositoryImpl newInstance(UserDao userDao, Context context) {
    return new UserRepositoryImpl(userDao, context);
  }
}
